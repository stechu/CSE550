...
\captionof{figure}{\color{Green} Google server motherboard and components unveiled in 2009 as described in ~\cite{googlehw}}
\end{center}\vspace{1cm}
...
\begin{center}\vspace{1cm}
\includegraphics[width=0.8\linewidth]{request_distributions.jpg}
...
\begin{center}\vspace{1cm}
\includegraphics[width=0.8\linewidth]{actual_distributions.jpg}
